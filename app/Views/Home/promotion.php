...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full" data-sidebar-position="absolute" data-header-position="absolute" data-boxed-layout="full">
        ...
        <header class="topbar" data-navbarbg="skin5">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <!-- Logo -->
                    <!-- ============================================================== -->
                    <a class="navbar-brand" href="<?= base_url() ?>/public/dashboard.html">
                        <!-- Logo icon -->
                        <b class="logo-icon">
                            <!-- Dark Logo icon -->
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav ms-auto d-flex align-items-center">
                        ...
                        <li>
                            <a class="profile-pic" href="<?= base_url() ?>/public/#">
        ...
        <div class="page-wrapper">
                ...
                if (session()->get('success') != null) { ?>
                    <div class="alert alert-success">
                        <p>
                            ...
                            <hr>
                            L'ajout de la promotion s'est éffectué avec succès !
                        </p>
                    </div>
                <?php
                    ...
                    <div class="alert alert-success">
                        <p>
                            <Strong>Mise à jour </Strong>
                            <hr>
                            La modification de la promotion s'est éffectuée avec succès !
                        </p>
                    </div>
                <?php
                }
                elseif(session()->get('success_delete') != null) { ?>
                    <div class="alert alert-success">
                        <p>
                            <Strong>Mise à jour </Strong>
                            <hr>
                            La suppression de la promotion s'est éffectuée avec succès !
                        </p>
                    </div>
                <?php
                }
                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12">
                        <div class="white-box">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal form-material" action="<?= base_url("public/Home/".(isset($la_promotion) ? "enregistrer_modification_promotion/".$la_promotion['id_promotion'] : "ajout_promotion"))?>" method="post">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 border-bottom p-0">
                                                        <input type="text" name="nom" value="<?= isset($la_promotion) ? $la_promotion['intitule'] : ''?>" class="form-control p-0 ">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <table class="table text-nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-top-0">ACTION DISPONIBLE</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                        if (isset($promotions)) {
                                            ...
                                            foreach($promotions as $key => $promotion) { ?>
                                                <tr>
                                                    ...
                                                    <td> <a href="<?= base_url('public/Home/etudiant/'. $promotion['id_promotion']) ?>" class="btn btn-success btn-lg text-white">Details-Eleve</a>
                                                        <a href="<?= base_url('public/Home/modifier_promotion/'. $promotion['id_promotion']) ?>" class="btn btn-primary btn-lg text-white">Modifier</a>
                                                        <a href="<?= base_url('public/Home/supprimer_promotion/'. $promotion['id_promotion']) ?>" class="btn btn-danger btn-lg text-white">Supprimer</a>
                                                    </td>
                                                </tr>
                                        <?php
                                                $i++;
            ...
            <footer class="footer text-center"> <a
                    href="https:<?= base_url()?>/public/">2021© MS-DeV | Gestion Ecole </a>
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
    ...
    <!--Wave Effects -->
    <script src="<?= base_url() ?>/public/plugins/js/waves.js"></script>
    <!--Menu sidebar -->
    <script src="<?= base_url() ?>/public/plugins/js/sidebarmenu.js"></script>
    <!--Custom JavaScript -->
