            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav ms-auto d-flex align-items-center">
                        ...
                        <!-- ============================================================== -->
                        <li>
                            <a class="profile-pic" href="<?= base_url()?>/public/accueil">
                                <img src="<?= base_url()?>/public/plugins/images/users/admin.png" alt="user-img" width="36"
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url()?>/public/Home/basic_table"
                                aria-expanded="false">
                        ...
                        <!-- <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url()?>/public/Home/fontawesome"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url()?>/public/Home/map-google"
                                aria-expanded="false">
                        ...
                        <!-- <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url()?>/public/Home/blank"
                                aria-expanded="false">
...
<!--
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<//?= base_url()?>/public/404.html"
                                aria-expanded="false">
...
-->
        ...
        <div class="page-wrapper">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex">
                            <ol class="breadcrumb ms-auto">
                                <li><a href="<?= base_url()?>/public/accueil" class="fw-normal">Accueil</a></li>
                            </ol>
                                    ...
                                    <div class="gm-style"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                Map Data</div>
                                            <div style="font-size: 13px;">Map data ©2021 Localisation</div><button
            ...
            <!-- footer -->
            <!-- ============================================================== -->
            <footer class="footer text-center"> 2021 © MSD-Dev Admin by <a
    ...
    <!-- google maps api -->
    <script src="<?= base_url()?>/public/http://maps.google.com/maps/api/js?sensor=true"></script>
    <script src="<?= base_url()?>/public/plugins/bower_components/gmaps/gmaps.min.js"></script>
    <script src="<?= base_url()?>/public/plugins/bower_components/gmaps/jquery.gmaps.js"></script>
    <!--Custom JavaScript -->
