...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex">
                            <ol class="breadcrumb ms-auto">
                                <li><a href="<?= base_url()?>/public/Home/profile" class="fw-normal">Profile</a></li>
                            </ol>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-12">
                        <div class="white-box">
                            <div class="user-bg"><img width="100%" alt="user" src="<?= base_url()?>/public/plugins/images/users/admin.png">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        <!-- <a href="javascript:void(0)"><img src="<//?= base_url()?>/public/plugins/images/users/utilisateur.png" -->
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" placeholder="+237 693 686 958"
                                    ...
                                    <div class="form-group mb-12">
                                        <div class="col-sm-4" style="float: left;">
                                            <button class="btn btn-success pull-left">Update Profile</button>
                                        </div>
                                        <div class="col-sm-8">
                                            <button class="btn btn-warning  d-none d-md-block pull-right ms-8 waves-light">Annuler Profile</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                ...
                <!-- Row --style="float: right; margin: left 150px;"
                <!- ============================================================== -->
                <!-- End PAge Content -->
                <!-- ============================================================== -->
                <!-- ============================================================== -->
            ...
            <!-- footer -->
            <!-- ============================================================== -->
            <footer class="footer text-center"> 2021 © Admin MS-Dev | App Horizon System<a></a>
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
